...
int main(int argc, char** argv) {
    ...
    /* grid node distance diameter */
    input_type i_mu={{32000.0 / divider, (8.0/9.0*M_PI/180) / divider}}; // Original value {{32000,8.0/9.0*M_PI/180}}
    scots::SymbolicSet ss_input(mgr,input_dim,i_lb,i_ub,i_mu);
    ss_input.print_info();
    ...
    string file_name = string("aircraft") + suffix;
